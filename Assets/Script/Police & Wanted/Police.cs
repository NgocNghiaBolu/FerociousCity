...
public class Police : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (playerInChaseRadius && !playerInShootRadius && wantedLevel.level1 == true || wantedLevel.level2 == true || wantedLevel.level3 == true || wantedLevel.level4 == true || wantedLevel.level5 == true)
        {
            ChasePlayer();
        }
        if (playerInChaseRadius && playerInShootRadius && wantedLevel.level1 == true || wantedLevel.level2 == true || wantedLevel.level3 == true || wantedLevel.level4 == true || wantedLevel.level5 == true)
    ...
    public void PoliceTakeDamage(float damage)
    {
